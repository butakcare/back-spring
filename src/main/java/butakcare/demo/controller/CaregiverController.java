    ...
    public class CaregiverController {
        ...
        public ResponseEntity<CaregiverResponseDto> getCaregiverProfile(@PathVariable Long caregiverId) {
            CaregiverResponseDto dto = caregiverService.getCaregiverProfile(caregiverId);
